...
- Find the Project's Include files which is mormally the last directory in this list. The file path is simialr to this `< filepath to your project directory>/Projects/Multi/Applications/LoRa/End_Node/inc`where the `< filepath to your project directory>` value is the location of your project on disk. In most cases this directory will be the last item in the list.
