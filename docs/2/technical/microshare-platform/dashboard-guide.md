...
* For Realtime Value app only, the fieldName fact must match the field name from the unpacker and the feildUnit fact is appedned to the value as part of the user display. Additionally, if you supplied a minIdeal dact, the values BELOW this value will be displayed in red, while if a maxIdeal fact is given, the values above will be displayed in red
...
* footerLogo: [https://s3.amazonaws.com/cdn.point.io/distribution/product/1_01/footer.png](https://s3.amazonaws.com/cdn.point.io/distribution/product/1_01/footer.png)
* headerLogo: [https://s3.amazonaws.com/cdn.point.io/distribution/product/1_01/footer.png](https://s3.amazonaws.com/cdn.point.io/distribution/product/1_01/header.png)
...
Add the child tag in the suite taf to the parent tag(s) feild of the relevant app(s) 
...
[https://dapp.microshare.io/guest/5e77ac483a0000df97452437?loc1=Haverhill&loc2=3rd%20Floor&loc3=C&dataContext=toilet](https://dapp.microshare.io/guest/5e77ac483a0000df97452437?loc1=Haverhill&loc2=3rd%20Floor&loc3=C&dataContext=toilet) 
