...
2. [Easy LoRaWan data formatting](./#2-sign-in)
  - A. [Device Clusters Parameters](./#1-requirements)
  - A. [Formatted data example](./#1-requirements)
3. [Formatting from another source](./#3-access-to-device-cluster)
...
## 2. Easy LoRaWan data formatting
### A. Device Clusters Parameters
### B. Formatted data example

## 3. Formatting from another source
