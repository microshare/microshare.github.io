---
layout: docs
title: Déballage des données par les Robots
description: Exemples de Robots pour construire un workflow de données
lang: fr
translation_of: docs/2/technical/microshare-platform-advanced/data-unpacking-by-robots.md
translations:
  en: /docs/2/technical/microshare-platform-advanced/data-unpacking-by-robots
  fr: /docs/2/fr/technical/microshare-platform-advanced/data-unpacking-by-robots
---
...
Vous pouvez utiliser les [VIEWS](/docs/2/technical/microshare-platform/views-guide/) pour effectuer des requêtes avancées sur le data lake.
...
<br>
**1.** Analyser le flux de données entrant pour isoler le Healthy Home Sensor.
<br>
**2.** Décoder la charge utile du Healthy Home Sensor.
<br>
**3.** Isoler les cas où le niveau de CO2 est élevé et ne transmettre que ceux-là à l'étape suivante.
<br>
