---
layout: docs
title: Décodage de charges utiles avec les Robots
description:
group: advanced
lang: fr
translation_of: docs/2/technical/microshare-platform-advanced/robots-libraries/decoding-payloads-new.md
translations:
  en: /docs/2/technical/microshare-platform-advanced/robots-libraries/decoding-payloads-new
  fr: /docs/2/fr/technical/microshare-platform-advanced/robots-libraries/decoding-payloads-new
---
### Décoder un message au format LPP

Basé sur les spécifications LPP définies par Cayenne dans [leur documentation](https://mydevices.com/cayenne/docs/lora/#lora-cayenne-low-power-payload)
Un format JSON de sortie est spécifié dans l'exemple ci-dessous.
...
### Encoder/décoder des messages Base64
...
### Conversion entre décimal, hexadécimal et binaire, positif ou négatif
