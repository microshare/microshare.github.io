---
layout: docs
title: Décodage TrackNet Tabs V1.1
description:
group: advanced
lang: fr
translation_of: docs/2/technical/microshare-platform-advanced/robots-libraries/tracknet-tabs.md
translations:
  en: /docs/2/technical/microshare-platform-advanced/robots-libraries/tracknet-tabs
  fr: /docs/2/fr/technical/microshare-platform-advanced/robots-libraries/tracknet-tabs
---
Basé sur les [spécifications TrackNet Tabs V1.1](/assets/pdf/Tabs.Sensors.Application.Payload.Specification.V1.1.pdf)
Les formats JSON de sortie sont spécifiés dans l'exemple ci-dessous.
