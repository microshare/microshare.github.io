---
layout: docs
title: Décodage Globalsat LT-100
description:
group: advanced
lang: fr
translation_of: docs/2/technical/microshare-platform-advanced/robots-libraries/globalsat-lt-100.md
translations:
  en: /docs/2/technical/microshare-platform-advanced/robots-libraries/globalsat-lt-100
  fr: /docs/2/fr/technical/microshare-platform-advanced/robots-libraries/globalsat-lt-100
---
Basé sur les [spécifications de format de l'appareil GPS Globalsat LT-100](/assets/pdf/Globalsat LT-100 format .pdf).
Utilisez le code ci-dessous dans votre Robot.
