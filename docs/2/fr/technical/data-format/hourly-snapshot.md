---
layout: docs
title: Format de données Hourly Snapshot
description: Découvrez le format de données Hourly Snapshot Microshare™
lang: fr
translation_of: docs/2/technical/data-format/hourly-snapshot.md
translations:
  en: /docs/2/technical/data-format/hourly-snapshot
  fr: /docs/2/fr/technical/data-format/hourly-snapshot
toc: true
---
