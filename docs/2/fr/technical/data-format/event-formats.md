---
layout: docs
title: Formats d'événements
description: Découvrez la structure des données d'événements Microshare™
lang: fr
translation_of: docs/2/technical/data-format/event-formats.md
translations:
  en: /docs/2/technical/data-format/event-formats
  fr: /docs/2/fr/technical/data-format/event-formats
toc: true
---
...
## 1. Format d'événement Microshare
---------------------------------------

Pour de nombreux cas d'usage, Microshare fournit une étape d'interprétation supplémentaire dans le pipeline pour transformer les télématiques au format décompressé (unpacked) en un format aligné avec la majorité des attentes analytiques. Un exemple : de nombreux appareils rapportent l'activité sous forme de compteur incrémental dans les données décompressées. Le pipeline suit les enregistrements successifs et produit les valeurs soustraites (le delta) sous forme d'enregistrement d'événement.


## 2. Exemple de données d'événement Feedback Microshare
---------------------------------------
...
## 3. Exemple de données d'événement Motion Microshare
---------------------------------------
