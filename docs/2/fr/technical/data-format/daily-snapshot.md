---
layout: docs
title: Format de données Daily Snapshot
description: Découvrez le format de données Daily Snapshot Microshare™
lang: fr
translation_of: docs/2/technical/data-format/daily-snapshot.md
translations:
  en: /docs/2/technical/data-format/daily-snapshot
  fr: /docs/2/fr/technical/data-format/daily-snapshot
toc: true
---
