---
layout: docs
title: Guide d'installation de la surveillance d'occupation des bureaux
description: Comment installer une solution Microshare de surveillance d'occupation des bureaux
lang: fr
translation_of: docs/2/installer/specific-installations/desk-occupancy-installation-guide.md
translations:
  en: /docs/2/installer/specific-installations/desk-occupancy-installation-guide
  fr: /docs/2/fr/installer/specific-installations/desk-occupancy-installation-guide
toc: true
---

---------------------------------------

Guide d'installation de la solution Desk Occupancy Monitoring
...
La solution Desk Occupancy Monitoring de Microshare est un service de détection complet pour les gestionnaires d'installations souhaitant mieux gérer la disponibilité de leurs postes de travail.

Que contient la boîte ? Pour un déploiement rapide, la solution Desk Occupancy Monitoring de Microshare comprend des capteurs sans fil alimentés par batterie à longue durée de vie, faciles à installer discrètement sous les bureaux, la connectivité des appareils, l'accès aux données et aux alertes via les tableaux de bord Microshare Business Tools ou l'accès API direct aux données via le Microshare Smart Network.
...
| **2.** **Préparation du capteur pour la fixation** <br><br>- Si vous fixez le capteur à l'aide d'un ruban adhésif approprié, placez le ruban du côté opposé au code QR. | {% include image.html url="/assets/img/installation_tabs/desk_occupancy/desk_occupancy_1.png" description="Banner" %}|
...
- Cliquez sur Add | {% include image.html url="/assets/img/installation_tabs/desk_occupancy/desk_occupancy_4.png" description="Banner" %}  |
| - Une fois le capteur ajouté au bon emplacement dans l'application, cliquez sur &#39;RESCAN&#39; pour ouvrir l'appareil photo | {% include image.html url="/assets/img/installation_tabs/desk_occupancy/desk_occupancy_5.png" description="Banner" %}|
| - Scannez le code QR situé sur le capteur | {% include image.html url="/assets/img/installation_tabs/desk_occupancy/desk_occupancy_6.png" description="Banner" %}|
| - Vérifiez que le Dev EUI [généralement le deuxième code sur le capteur sous le code QR] affiché correspond à celui de votre appareil, puis sélectionnez save en bas de l'écran. | {% include image.html url="/assets/img/installation_tabs/desk_occupancy/desk_occupancy_7.png" description="Banner" %}|
| **4.** **Fixation du capteur sans fil** <br><br>- Une fois l'enregistrement du capteur terminé dans l'application Deploy-M, vous pouvez fixer le capteur en place. <br>- Retirez l'autocollant à l'arrière de l'appareil et collez l'appareil dans l'un des coins arrière sous le bureau, avec l'objectif orienté à environ 45 degrés vers l'ouverture du bureau. Cette image montre une vue en plongée de l'emplacement recommandé. <br>- **N'oubliez pas d'installer sous le bureau** [comme indiqué sur la deuxième photo]  | {% include image.html url="/assets/img/installation_tabs/desk_occupancy/desk_occupancy_8.png" description="Banner" %}|
