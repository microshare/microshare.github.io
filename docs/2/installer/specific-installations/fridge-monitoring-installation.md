...
| --- | --- |
| **1.** **Activating the sensor** <br>- Our wireless sensors are pre-installed with batteries. To activate simply hold a magnet against the raised circle highlighted in the picture. You will know the device is activated as the device LED's will flash through the plastic in the bottom of the device<br><br>See example in this video: {% include youtube_video.html url="https://www.youtube.com/embed/Jvxx7kxU-Y4?start=126" description="Activating the Fridge Monitoring sensor battery" %} | {% include image.html url="/assets/img/Installation_fridge/FridgeSensor1.png" description="Fridge Sensor" %} |
